...
(function(global, factory) {
    ...
    class ConstructorFragment extends Fragment {
        ...
        format(format) {
            assert$1(format != null && format !== "sighash", "cannot format a constructor for sighash", "UNSUPPORTED_OPERATION", {
    ...
    class Interface {
        ...
        encodeFilterTopics(fragment, values) {
            ...
            assert$1(values.length <= fragment.inputs.length, `too many arguments for ${fragment.format()}`, "UNEXPECTED_ARGUMENT", {
                count: values.length,
